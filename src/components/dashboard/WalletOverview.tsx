  ...
  return (
    <GlassCard glow="green" className="h-full">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        ...
        <div className="bg-secondary/50 rounded-lg p-3">
          <p className="text-xs text-muted-foreground mb-1">In Orders</p>
      ...
      <div className="flex gap-3">
        ...
        <Button variant="outline" className="flex-1 border-glass-border bg-secondary/30 hover:bg-secondary/50">
