...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'withdraw.tax_message': 'A processing tax of 500 DA must be paid via Baridi Mob to complete your withdrawal.',
    'withdraw.send_to': 'Send 500 DA to this CCP account:',
  ...
  ar: {
    ...
    'withdraw.tax_message': 'يجب دفع رسوم معالجة قدرها 500 دج عبر بريدي موب لإتمام السحب.',
    'withdraw.send_to': 'أرسل 500 دج إلى حساب CCP هذا:',
